...
def main():
    ...
    output_file = Path(r"ticket_submission.json")
    ...
    print(f"Directories WITH ticket_submission.json: {len(has_ticket)}")
    print(f"Directories WITHOUT ticket_submission.json: {len(missing_ticket)}")
    
    if missing_ticket:
        print("\n--- DIRECTORIES WITHOUT ticket_submission.json ---")
