...
print(f"Generated {len(nodes_list)} nodes -> data_json/nodes.json")
print(f"Generated {len(edges_list)} edges -> data_json/edges.json")
print(f"Generated {len(tickets_list)} tickets -> data_json/tickets.json")
